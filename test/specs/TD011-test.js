...
const testID = "TD011",
  ...
  rootDir = path.resolve(__dirname, "../fixtures/resources/TD011"),
...
describe(`${testID} - endpoint passes SSLInfo IgnoreValidationErrors check`, function () {
...
describe(`${testID} - endpoint does not pass SSLInfo IgnoreValidationErrors check`, () => {
