  ...
  function (endpoint) {
    ...
    endpoint.getSteps().forEach((step) => {
      ...
      endpoint.addMessage({
        ...
        message: `For the ${policyType} step (${policyName}), an appropriate check for a message body was not found. For example, use <Condition>${exampleCondition(source)}</Condition>`,
      });
    });
