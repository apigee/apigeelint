        ...
        if (avNodes && avNodes.length>0) {
          ...
          avNodes.forEach( (node, ix) => {
            ...
            if (childNodes.length == 0) {
              ...
              let found = { Name:0, Template:0, Value:0, Ref:0, PropertySetRef:0 };
              ...
              if (found.Value == 0 && found.Template == 0 && found.Ref == 0 && found.PropertySetRef == 0) {
                addNodeMessage("You should have at least one of: {Ref, Value, Template, PropertySetRef}");
              }
