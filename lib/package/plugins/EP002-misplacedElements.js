...
const allowedChildren = {
        Step: ['Name', 'Condition'],
        Request: ['Step'],
        'Request2-B1A78759FA67': ['ConnectTimeoutInSec', 'SocketReadTimeoutInSec', 'Payload', 'IsSSL', 'TrustAllSSL', 'Port', 'Verb', 'Path', 'Header', 'IncludeHealthCheckIdHeader'],
        Response: ['Step'],
        Flows: ['Flow'],
        Flow: ['Description', 'Request', 'Response', 'Condition'],
        RouteRule: ['Condition', 'TargetEndpoint'],
        DefaultFaultRule: ['Step', 'AlwaysEnforce'],
        HTTPTargetConnection: ['LoadBalancer', 'Properties', 'Path', 'HealthMonitor'],
