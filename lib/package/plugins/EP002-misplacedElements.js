...
const allowedParents = {
        ...
        Request: ['PreFlow', 'PostFlow', 'Flow', 'PostClientFlow', 'HTTPMonitor'], //Request is a child within the HTTPMonitor config
...
const allowedChildren = {
        Step: ['Name', 'Condition'],
        Request: ['Step', 'ConnectTimeoutInSec', 'SocketReadTimeoutInSec', 'Port', 'Verb', 'Path'], //'ConnectTimeoutInSec', 'SocketReadTimeoutInSec', 'Port', 'Verb', 'Path' are part of the Request object in the HTTPMonitor config
        Response: ['Step'],
        Flows: ['Flow'],
